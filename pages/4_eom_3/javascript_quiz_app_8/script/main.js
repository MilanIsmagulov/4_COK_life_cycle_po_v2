...
let mainQuestions = [
    {
        text: 'Перечислите все варианты моделей жизненного цикла:',
        right: [0,1,4],
        type: 3,
        points: 100,
        answers: ['Инкрементальная модель', 'Спиральная модель', 'Поведенческая модель', 'Спецификационная модель', 'Водопадная модель'],
    },
];
...
//Несколько ответов без картинки
    ...
    nextBtn.setAttribute('onclick', "location.href='../javascript_quiz_app_9/index.html'")
