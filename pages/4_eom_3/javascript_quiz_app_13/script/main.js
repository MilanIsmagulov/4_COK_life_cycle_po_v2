...
let mainQuestions = [
    {
        text: 'В какой модели жизненного цикла программного продукта сроки реализации могут быть неизвестны:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['каскадная', 'спиральная', 'инкрементальная', 'разработка через тестирование', ],
    },
];
