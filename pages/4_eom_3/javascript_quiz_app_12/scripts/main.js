...
let questions = [
    {
        text: 'Какие преимущества имеет разработка через тестирование (TDD):',
        right: 2,
        answers: ['быстрая обратная связь, низкая стоимость', 'последовательное выполнение этапов проекта', 'минимум ошибок в архитектуре', ],
    },
];
