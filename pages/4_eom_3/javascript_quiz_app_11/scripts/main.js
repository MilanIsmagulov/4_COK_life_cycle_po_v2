...
let questions = [
    {
        text: 'Что предполагает инкрементальная модель жизненного цикла программного продукта:',
        right: 3,
        answers: ['Последовательное выполнение этапов проекта', 'Написание тестов перед кодом', 'Постоянная поддержка и исправление ошибок', 'Постепенное предоставление программного обеспечения частями'],
    },
];
