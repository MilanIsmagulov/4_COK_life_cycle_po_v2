...
let mainQuestions = [
    {
        text: 'Какая модель жизненного цикла программного продукта предполагает последовательное выполнение этапов проекта:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['спиральная', 'каскадная', 'разработка через тестирование', 'инкрементальная'],
    },
];
