...
let questions = [
    {
        text: 'Какие этапы включает жизненный цикл программного обеспечения:',
        right: 2,
        answers: ['Планирование, разработка, маркетинг, продажа и поддержка', 'Исследование, разработка, производство, маркетинг и анализ', 'Анализ требований, проектирование, реализация, тестирование и обслуживание', 'Анализ, дизайн, производство, тестирование и продажа'],
    },
];
