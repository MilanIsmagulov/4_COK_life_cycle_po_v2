...
let questions = [
    {
        ...
        right: 3,
        answers: ['Анализ требований, проектирование, реализация', 'Проектирование, внедрение, эксплуатация', 'Анализ требований, реализация, эксплуатация','Анализ требований, проектирование, реализация, <br> внедрение, эксплуатация'],
    },
];
