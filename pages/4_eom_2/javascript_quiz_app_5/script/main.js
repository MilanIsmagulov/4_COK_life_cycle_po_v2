...
let mainQuestions = [
    {
        text: 'Укажите, какие методы могут использоваться для обеспечения высокой эффективности и взаимодействия между системами в жизненном цикле ПО:',
        right: [1,3,0,2,4],
        type: 3,
        points: 100,
        answers: ['ГОСТ 34.601-90', 'ISO/IEC 12207', 'Rational Unified Process', 'Microsoft Solution Framework','Extreme Programming'],
    },
];
...
//Несколько ответов без картинки
    ...
    nextBtn1.setAttribute('onclick', "location.href='../javascript_quiz_app_4/index.html'")
    ...
    nextBtn.setAttribute('onclick', "location.href='../javascript_quiz_app_6/index.html'")
