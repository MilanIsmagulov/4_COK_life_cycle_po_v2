...
let mainQuestions = [
    {
        text: 'Укажите свойства спиральной модели жизненного цикла:',
        right: [3,4],
        type: 3,
        points: 100,
        answers: ['на каждом витке спирали выполняется создание очередной версии продукта, уточняются требования проекта', 'переход на следующий этап означает полное завершение работ на предыдущем этапе', 'позволяет планировать сроки завершения всех работ и соответствующие затраты', 'на каждом витке спирали планируются работы следующего витка','требования проекта постоянно уточняются'],
    },
];
...
//Несколько ответов без картинки
    ...
    nextBtn1.setAttribute('onclick', "location.href='../javascript_quiz_app_11/index.html'")
    ...
    nextBtn.setAttribute('onclick', "location.href='../javascript_quiz_app_13/index.html'")
