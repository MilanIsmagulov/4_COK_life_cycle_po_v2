...
let mainQuestions = [
    {
        text: 'Укажите, что представляет собой жизненный цикл программного обеспечения:',
        right: [1],
        type: 1,
        points: 100,
        answers: ['Процесс создания программного обеспечения', 'Период времени, начиная с момента создания системы до ее полного изъятия из эксплуатации', 'Методология проектирования программного обеспечения','Стадии и процессы, описывающие жизненный цикл программного обеспечения'],
    },
];
